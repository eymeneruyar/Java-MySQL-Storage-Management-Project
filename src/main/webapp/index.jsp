                    ...
                    <div class="col-md-8">
                        ...
                        <form action="login-servlet" method="post">
                            <div class="form-floating mb-3">
                                <input name="emailForm" type="text" class="form-control" id="username" placeholder="E-Mail" required/>
                                <label for="username">E-Mail</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input name="passwordForm" type="password" class="form-control" id="password" placeholder="Şifre" required/>
                                <label for="password">Şifre</label>
                            </div>

                            <div class="d-flex mb-1 align-items-center">
                                <label class="control control--checkbox mb-0"><span class="caption">Beni Hatırla</span>
                                    <input name="rememberForm" type="checkbox" checked="checked"/>
                            ...
                            <div class="d-flex mb-4 align-items-center">
                                <div class="invalid-feedback" style="display: block;">
                                    ...
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong style="color: black">Hata!</strong> <%=errorMessage%>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" style="color: black">Şifre Hatırlat</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form id="rememberPassword_form">

                <div class="modal-body" >
                    <div class="form-floating mb-1">
                        <input name="rememberPasswordForm" id="pass_email" type="text" aria-describedby="emailHelp" class="form-control"  placeholder="E-Mail" required/>
                        <label for="username">E-Mail</label>
                    ...
                    <div id="pass_fail" class="invalid-feedback" style="display: block;">
                        <!-- Bu blok rememberPassword.js dosyasında tanımlanmıştır. -->
                    </div>
...
<script src="js/rememberPassword.js"></script>
</body>
</html>